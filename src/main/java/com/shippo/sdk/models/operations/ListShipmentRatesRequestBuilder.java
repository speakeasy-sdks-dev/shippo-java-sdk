...
public class ListShipmentRatesRequestBuilder {
    ...
    public ListShipmentRatesRequestBuilder shipmentId(java.lang.String shipmentId) {
    ...
    public ListShipmentRatesRequestBuilder page(java.util.Optional<java.lang.Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
    ...
    public ListShipmentRatesRequestBuilder results(java.util.Optional<java.lang.Long> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
                
    public ListShipmentRatesRequestBuilder shippoApiVersion(java.lang.String shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
        this.shippoApiVersion = Optional.of(shippoApiVersion);
        return this;
    }

    public ListShipmentRatesRequestBuilder shippoApiVersion(java.util.Optional<java.lang.String> shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
