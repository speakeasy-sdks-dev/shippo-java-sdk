...
public class GetAddressRequestBuilder {
    ...
    public GetAddressRequestBuilder addressId(java.lang.String addressId) {
        Utils.checkNotNull(addressId, "addressId");
        this.addressId = addressId;
        return this;
    }
                
    public GetAddressRequestBuilder shippoApiVersion(java.lang.String shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
        this.shippoApiVersion = Optional.of(shippoApiVersion);
        return this;
    }

    public GetAddressRequestBuilder shippoApiVersion(java.util.Optional<java.lang.String> shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
