...
public class ListParcelsRequestBuilder {
    ...
    public ListParcelsRequestBuilder page(java.util.Optional<java.lang.Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
    ...
    public ListParcelsRequestBuilder results(java.util.Optional<java.lang.Long> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
                
    public ListParcelsRequestBuilder shippoApiVersion(java.lang.String shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
        this.shippoApiVersion = Optional.of(shippoApiVersion);
        return this;
    }

    public ListParcelsRequestBuilder shippoApiVersion(java.util.Optional<java.lang.String> shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
