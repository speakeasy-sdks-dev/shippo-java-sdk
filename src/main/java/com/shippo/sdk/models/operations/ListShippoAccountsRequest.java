...
public class ListShippoAccountsRequest {
    ...
    @JsonCreator
    public ListShippoAccountsRequest(
            Optional<Long> page,
     ...
     * The page number you want to select
     */
    public ListShippoAccountsRequest withPage(long page) {
        Utils.checkNotNull(page, "page");
     ...
     * The page number you want to select
     */
    public ListShippoAccountsRequest withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results to return per page (max 100)
     */
    public ListShippoAccountsRequest withResults(long results) {
        Utils.checkNotNull(results, "results");
     ...
     * The number of results to return per page (max 100)
     */
    public ListShippoAccountsRequest withResults(Optional<Long> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
     ...
     * String used to pick a non-default API version to use
     */
    public ListShippoAccountsRequest withShippoApiVersion(String shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
     ...
     * String used to pick a non-default API version to use
     */
    public ListShippoAccountsRequest withShippoApiVersion(Optional<String> shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
        this.shippoApiVersion = shippoApiVersion;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListShippoAccountsRequest other = (ListShippoAccountsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListShippoAccountsRequest.class,
                "page", page,
                "results", results,
    ...
    public final static class Builder {
        ...
        public ListShippoAccountsRequest build() {
            if (page == null) {
            ...
            return new ListShippoAccountsRequest(
                page,
                results,
                shippoApiVersion);
        }
