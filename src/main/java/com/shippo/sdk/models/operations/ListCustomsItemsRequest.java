...
public class ListCustomsItemsRequest {
     ...
     * The page number you want to select
     */
    public ListCustomsItemsRequest withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results to return per page (max 100)
     */
    public ListCustomsItemsRequest withResults(Optional<Long> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
     ...
     * String used to pick a non-default API version to use
     */
    public ListCustomsItemsRequest withShippoApiVersion(Optional<String> shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
        this.shippoApiVersion = shippoApiVersion;
        return this;
    }
