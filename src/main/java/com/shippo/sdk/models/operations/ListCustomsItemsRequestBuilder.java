...
public class ListCustomsItemsRequestBuilder {
    ...
    public ListCustomsItemsRequestBuilder page(java.util.Optional<java.lang.Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
    ...
    public ListCustomsItemsRequestBuilder results(java.util.Optional<java.lang.Long> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
                
    public ListCustomsItemsRequestBuilder shippoApiVersion(java.lang.String shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
        this.shippoApiVersion = Optional.of(shippoApiVersion);
        return this;
    }

    public ListCustomsItemsRequestBuilder shippoApiVersion(java.util.Optional<java.lang.String> shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
