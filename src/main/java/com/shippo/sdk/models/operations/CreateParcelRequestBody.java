    ...
    public static final class _Deserializer extends OneOfDeserializer<CreateParcelRequestBody> {
        ...
        public _Deserializer() {
            super(CreateParcelRequestBody.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.shippo.sdk.models.components.ParcelCreateRequest>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.shippo.sdk.models.components.ParcelCreateFromTemplateRequest>() {}, JsonShape.DEFAULT));
        }
    }
