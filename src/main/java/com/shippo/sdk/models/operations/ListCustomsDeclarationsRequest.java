...
public class ListCustomsDeclarationsRequest {
    ...
    @JsonCreator
    public ListCustomsDeclarationsRequest(
            Optional<Long> page,
     ...
     * The page number you want to select
     */
    public ListCustomsDeclarationsRequest withPage(long page) {
        Utils.checkNotNull(page, "page");
     ...
     * The page number you want to select
     */
    public ListCustomsDeclarationsRequest withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results to return per page (max 100, default 5)
     */
    public ListCustomsDeclarationsRequest withResults(long results) {
        Utils.checkNotNull(results, "results");
     ...
     * The number of results to return per page (max 100, default 5)
     */
    public ListCustomsDeclarationsRequest withResults(Optional<Long> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
     ...
     * String used to pick a non-default API version to use
     */
    public ListCustomsDeclarationsRequest withShippoApiVersion(String shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
     ...
     * String used to pick a non-default API version to use
     */
    public ListCustomsDeclarationsRequest withShippoApiVersion(Optional<String> shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
        this.shippoApiVersion = shippoApiVersion;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListCustomsDeclarationsRequest other = (ListCustomsDeclarationsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListCustomsDeclarationsRequest.class,
                "page", page,
                "results", results,
    ...
    public final static class Builder {
        ...
        public ListCustomsDeclarationsRequest build() {
            if (page == null) {
            ...
            return new ListCustomsDeclarationsRequest(
                page,
                results,
                shippoApiVersion);
        }
