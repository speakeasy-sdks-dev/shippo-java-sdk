...
public class DeleteUserParcelTemplateRequestBuilder {
    ...
    public DeleteUserParcelTemplateRequestBuilder userParcelTemplateObjectId(java.lang.String userParcelTemplateObjectId) {
    ...
    public DeleteUserParcelTemplateRequestBuilder shippoApiVersion(java.lang.String shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
        this.shippoApiVersion = Optional.of(shippoApiVersion);
        return this;
    }

    public DeleteUserParcelTemplateRequestBuilder shippoApiVersion(java.util.Optional<java.lang.String> shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
