    ...
    public static final class _Deserializer extends OneOfDeserializer<ParcelTemplateEnumSet> {
        ...
        public _Deserializer() {
            super(ParcelTemplateEnumSet.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.shippo.sdk.models.components.ParcelTemplateAramexAustraliaEnum>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.shippo.sdk.models.components.ParcelTemplateCouriersPleaseEnum>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.shippo.sdk.models.components.ParcelTemplateDPDUKEnum>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.shippo.sdk.models.components.ParcelTemplateDHLeCommerceEnum>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.shippo.sdk.models.components.ParcelTemplateUSPSEnum>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.shippo.sdk.models.components.ParcelTemplateUPSEnum>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.shippo.sdk.models.components.ParcelTemplateFedExEnum>() {}, JsonShape.DEFAULT));
        }
    }
